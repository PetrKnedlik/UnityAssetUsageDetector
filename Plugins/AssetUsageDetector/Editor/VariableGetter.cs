...
namespace AssetUsageDetectorNamespace
{
    ...
    public readonly struct VariableGetterHolder
    {
        ...
        {
            get { return variable is PropertyInfo; }
        }
        ...
        public readonly object Get(object obj)
        {
            ...
            catch (Exception e)
            {
                ...
                sb.Length = 0;
                sb.Append("Error while getting the value of (")
                    .Append(
                        IsProperty
    ...
    public class PropertyWrapper<TObject, TValue> : IPropertyAccessor
        where TObject : class
    {
        ...
        public PropertyWrapper(MethodInfo getterMethod)
        {
            getter =
                (Func<TObject, TValue>)
                    Delegate.CreateDelegate(typeof(Func<TObject, TValue>), getterMethod);
        }
