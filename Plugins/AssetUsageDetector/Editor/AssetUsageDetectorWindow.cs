...
namespace AssetUsageDetectorNamespace
{
    ...
    public class AssetUsageDetectorWindow : EditorWindow, IHasCustomMenu
    {
        ...
        private const string PREFS_SEARCH_UNUSED_MATERIAL_PROPERTIES =
            "AUD_SearchUnusedMaterialProps";
        ...
        private const string PREFS_HIDE_REDUNDANT_PREFAB_REFERENCES_IN_ASSETS =
            "AUD_HideRedundantPRefsInAssets";
        private const string PREFS_HIDE_REDUNDANT_PREFAB_REFERENCES_IN_SCENES =
            "AUD_HideRedundantPRefsInScenes";
        ...
        private readonly GUIContent hideRedundantPrefabReferencesInAssetsLabel = new GUIContent(
            "Hide redundant prefab references in Assets",
            "Hides redundant/non-overridden references in prefab variants and nested prefabs. "
        ...
        private readonly GUIContent hideRedundantPrefabReferencesInScenesLabel = new GUIContent(
            "Hide redundant prefab references in Scenes",
            "Hides redundant/non-overridden references in prefab instances. "
                + "This will help focus on only the references that actually matter. For example:\n\n"
        ...
        private List<ObjectToSearch> objectsToSearch = new List<ObjectToSearch>()
        {
            new ObjectToSearch(null),
        };
            ...
            set
            {
                if (m_isLocked != value)
                {
                    ...
                    titleContent = value
                        ? new GUIContent(
                            "[L] " + windowTitle.text,
                            EditorGUIUtility.IconContent("InspectorLock").image
                        )
                        : windowTitle;
                }
            }
        ...
        private BindingFlags fieldModifiers,
            propertyModifiers;

        private SearchRefactoring searchRefactoring = null; // Its value can be assigned via ShowAndSearch

        private readonly ObjectToSearchListDrawer objectsToSearchDrawer =
            new ObjectToSearchListDrawer();
        private readonly ObjectListDrawer searchInAssetsSubsetDrawer = new ObjectListDrawer(
            "Search following asset(s) only:",
            false
        );
        private readonly ObjectListDrawer excludedAssetsDrawer = new ObjectListDrawer(
            "Don't search following asset(s):",
            false
        );
        private readonly ObjectListDrawer excludedScenesDrawer = new ObjectListDrawer(
            "Don't search in following scene(s):",
            false
        );
        ...
        void IHasCustomMenu.AddItemsToMenu(GenericMenu contextMenu)
        {
            ...
            if (currentPhase == Phase.Setup)
            {
                contextMenu.AddSeparator("");
                contextMenu.AddItem(
                    new GUIContent("Refresh Sub-Assets of Searched Objects"),
                    false,
                    () =>
                    {
        ...
        {
            AssetUsageDetectorWindow[] windows =
                Resources.FindObjectsOfTypeAll<AssetUsageDetectorWindow>();
            ...
            if (
                window
                && (
                    filter == WindowFilter.AlwaysReturnActive
        ...
        [MenuItem("Tools/Asset Usage Detector/Active Window")]
        private static void OpenActiveWindow()
        {
            GetWindow(WindowFilter.AlwaysReturnActive);
        }

        [MenuItem("Tools/Asset Usage Detector/New Window")]
        ...
        public static void ShowAndSearch(
            IEnumerable<Object> searchObjects,
        ...
        // Quickly show the AssetUsageDetector window and initiate a search
        public static void ShowAndSearch(
            AssetUsageDetector.Parameters searchParameters,
            bool? shouldSearchChildren = null
        )
        {
            ...
            GetWindow(WindowFilter.ReturnActiveIfNotLocked)
                .ShowAndSearchInternal(
                    searchParameters.objectsToSearch,
                    searchParameters,
        ...
        private void ShowAndSearchInternal(
            IEnumerable<Object> searchObjects,
            AssetUsageDetector.Parameters searchParameters,
        ...
        )
        {
            ...
            if (searchParameters != null)
            {
                ...
                hideRedundantPrefabReferencesInAssets =
                    searchParameters.hideRedundantPrefabReferencesInAssets;
                hideRedundantPrefabReferencesInScenes =
                    searchParameters.hideRedundantPrefabReferencesInScenes;
        ...
        private void SavePrefs()
        {
            ...
            EditorPrefs.SetBool(
                PREFS_SEARCH_UNUSED_MATERIAL_PROPERTIES,
            ...
            EditorPrefs.SetBool(
                PREFS_HIDE_REDUNDANT_PREFAB_REFERENCES_IN_ASSETS,
                hideRedundantPrefabReferencesInAssets
            );
            EditorPrefs.SetBool(
                PREFS_HIDE_REDUNDANT_PREFAB_REFERENCES_IN_SCENES,
                hideRedundantPrefabReferencesInScenes
            );
        ...
        {
            ParseSceneSearchMode(
                (SceneSearchMode)
                    EditorPrefs.GetInt(
                        PREFS_SEARCH_SCENES,
                        (int)(
                            SceneSearchMode.OpenScenes
                            | SceneSearchMode.ScenesInBuildSettingsTickedOnly
                            | SceneSearchMode.AllScenes
                        )
                    )
            );
            searchInSceneLightingSettings = EditorPrefs.GetBool(
                PREFS_SEARCH_SCENE_LIGHTING_SETTINGS,
                true
            );
            ...
            fieldModifiers = (BindingFlags)
                EditorPrefs.GetInt(
                    PREFS_SEARCH_FIELDS,
                    (int)(BindingFlags.Public | BindingFlags.NonPublic)
                );
            propertyModifiers = (BindingFlags)
                EditorPrefs.GetInt(
                    PREFS_SEARCH_PROPERTIES,
                    (int)(BindingFlags.Public | BindingFlags.NonPublic)
                );
            searchNonSerializableVariables = EditorPrefs.GetBool(
                PREFS_SEARCH_NON_SERIALIZABLES,
                true
            );
            searchUnusedMaterialProperties = EditorPrefs.GetBool(
                PREFS_SEARCH_UNUSED_MATERIAL_PROPERTIES,
                true
            );
            ...
            hideRedundantPrefabReferencesInAssets = EditorPrefs.GetBool(
                PREFS_HIDE_REDUNDANT_PREFAB_REFERENCES_IN_ASSETS,
                hideRedundantPrefabReferencesInAssets
            );
            hideRedundantPrefabReferencesInScenes = EditorPrefs.GetBool(
                PREFS_HIDE_REDUNDANT_PREFAB_REFERENCES_IN_SCENES,
                hideRedundantPrefabReferencesInScenes
            );
        ...
        {
            searchInOpenScenes =
                (sceneSearchMode & SceneSearchMode.OpenScenes) == SceneSearchMode.OpenScenes;
            searchInScenesInBuild =
            ...
            searchInScenesInBuildTickedOnly =
                ...
                != SceneSearchMode.ScenesInBuildSettingsAll;
            searchInAllScenes =
                (sceneSearchMode & SceneSearchMode.AllScenes) == SceneSearchMode.AllScenes;
        }
        ...
        private void OnGUI()
        {
            ...
            scrollPosition = EditorGUILayout.BeginScrollView(
                scrollPosition,
                Utilities.GL_EXPAND_WIDTH,
                Utilities.GL_EXPAND_HEIGHT
            );
            ...
            if (currentPhase == Phase.Processing)
            {
                ...
                GUILayout.Label(
                    ". . . Search in progress or something went wrong (check console) . . ."
                );
            ...
            else if (currentPhase == Phase.Setup)
            {
                ...
                searchInAssetsFolder = WordWrappingToggleLeft(
                    "Project window (Assets folder)",
                    searchInAssetsFolder
                );
                ...
                dontSearchInSourceAssets = WordWrappingToggleLeft(
                ...
                searchInOpenScenes = WordWrappingToggleLeft(
                ...
                {
                    searchInScenesInBuild = WordWrappingToggleLeft(
                    ...
                    if (searchInScenesInBuild)
                    {
                        ...
                        searchInScenesInBuildTickedOnly = EditorGUILayout.ToggleLeft(
                            "Ticked only",
                            searchInScenesInBuildTickedOnly,
                            Utilities.GL_WIDTH_100
                        );
                        searchInScenesInBuildTickedOnly = !EditorGUILayout.ToggleLeft(
                            "All",
                            !searchInScenesInBuildTickedOnly,
                    ...
                    searchInAllScenes = WordWrappingToggleLeft(
                ...
                EditorGUI.BeginDisabledGroup(
                    !searchInOpenScenes && !searchInScenesInBuild && !searchInAllScenes
                );
                searchInSceneLightingSettings = WordWrappingToggleLeft(
                ...
                searchInProjectSettings = WordWrappingToggleLeft(
                    "Project Settings (Player Settings, Graphics Settings etc.)",
...
#endif
                lazySceneSearch = WordWrappingToggleLeft(
                    "Lazy scene search: scenes are searched in detail only when they are manually refreshed (faster search)",
                    lazySceneSearch
                );
#if ASSET_USAGE_ADDRESSABLES
                EditorGUI.EndDisabledGroup();
                addressablesSupport = WordWrappingToggleLeft(
                    "Addressables support (Experimental) (WARNING: 'Lazy scene search' will be disabled) (slower search)",
                    addressablesSupport
                );
#endif
                calculateUnusedObjects = WordWrappingToggleLeft(
                    "Calculate unused objects",
                    calculateUnusedObjects
                );
                hideDuplicateRows = WordWrappingToggleLeft(
                    "Hide duplicate rows in search results",
                    hideDuplicateRows
                );
                hideRedundantPrefabReferencesInAssets = WordWrappingToggleLeft(
                    hideRedundantPrefabReferencesInAssetsLabel,
                    hideRedundantPrefabReferencesInAssets
                );
                hideRedundantPrefabReferencesInScenes = WordWrappingToggleLeft(
                    hideRedundantPrefabReferencesInScenesLabel,
                    hideRedundantPrefabReferencesInScenes
                );
                noAssetDatabaseChanges = WordWrappingToggleLeft(
                    "I haven't modified any assets/scenes since the last search (faster search)",
            ...
            else if (currentPhase == Phase.Complete)
            {
                ...
                if (searchResult == null)
                {
                    ...
                    EditorGUILayout.HelpBox(
                        "ERROR: search was interrupted, check the logs for more info",
                        MessageType.Error
                    );
                ...
                else
                {
                    ...
                    scrollPosition.y = searchResult.DrawOnGUI(
                        this,
                        scrollPosition.y,
                        noAssetDatabaseChanges
                    );
        ...
        private void DrawObjectsToSearchSection()
        {
            ...
            drawObjectsToSearchSection = EditorGUI.Foldout(
                searchedObjectsHeaderRect,
                drawObjectsToSearchSection,
                GUIContent.none,
                true
            );
        ...
        private void InitiateSearch()
        {
            ...
            // Start searching
            searchResult = core.Run(
                new AssetUsageDetector.Parameters()
                {
                    ...
                    searchInAssetsSubset = !searchInAssetsSubset.IsEmpty()
                        ? searchInAssetsSubset.ToArray()
                        : null,
                    excludedAssetsFromSearch = !excludedAssets.IsEmpty()
                        ? excludedAssets.ToArray()
                        : null,
                    dontSearchInSourceAssets = dontSearchInSourceAssets,
                    excludedScenesFromSearch = !excludedScenes.IsEmpty()
                        ? excludedScenes.ToArray()
                        : null,
                    ...
                    hideRedundantPrefabReferencesInScenes =
                        hideRedundantPrefabReferencesInScenes && searchInAssetsFolder,
        ...
        public void ReplacePrefabStageObjectsWithAssets(PrefabStage prefabStage)
        {
            ...
            for (int i = 0; i < objectsToSearch.Count; i++)
            {
                ...
                {
                    GameObject prefabStageObjectSource = ((GameObject)obj).FollowSymmetricHierarchy(
        ...
        internal void OnSettingsChanged(
            bool highlightedSearchTextColorChanged = false,
        ...
        )
        {
            ...
            wantsMouseMove = wantsMouseEnterLeaveWindow =
                AssetUsageDetectorSettings.ShowCustomTooltip;
            ...
            for (int i = searchResult.NumberOfGroups - 1; i >= 0; i--)
            {
                if (searchResult[i].treeView != null)
                {
                    searchResult[i].treeView.rowHeight =
                        ...
                        + AssetUsageDetectorSettings.ExtraRowHeight;
                    searchResult[i]
                        .treeView.OnSettingsChanged(
                            highlightedSearchTextColorChanged,
                            tooltipDescriptionsColorChanged
                        );
                }
            }
        }
