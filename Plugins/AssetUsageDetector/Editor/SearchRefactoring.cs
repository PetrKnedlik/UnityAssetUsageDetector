...
namespace AssetUsageDetectorNamespace
{
    ...
    public abstract class SearchMatch
    {
        ...
        protected SearchMatch(object source, Object value, Object context)
            : this(source, value)
        {
            Context = context;
        }
                    ...
                    else if (!EditorApplication.isPlaying)
                    {
                        ...
                        if (Context is Component)
                            EditorSceneManager.MarkSceneDirty(
                                ((Component)Context).gameObject.scene
                            );
    ...
    public abstract class GenericSearchMatch : SearchMatch
    {
        ...
        internal GenericSearchMatch(object source, Object value, SetterFunction setter)
            : base(source, value)
        {
            Setter = setter;
        }

        internal GenericSearchMatch(
            object source,
            Object value,
            Object context,
            SetterFunction setter
        )
            : base(source, value, context)
        {
            Setter = setter;
        }
    ...
    {
        internal ReadOnlySearchMatch(object source, Object value)
            : base(source, value) { }
    ...
    public class SerializedPropertyMatch : SearchMatch
    {
        ...
        internal SerializedPropertyMatch(Object source, Object value, SerializedProperty property)
            : base(source, value)
        {
        ...
        protected override bool ChangeValue(Object newValue, out bool setContextDirty)
        {
            ...
            switch (SerializedProperty.propertyType)
            {
                case SerializedPropertyType.ObjectReference:
                    ...
                    {
                        Debug.LogWarning(
                            "Couldn't cast " + newValue.GetType() + " to " + SerializedProperty.type
                        );
    ...
    public class ReflectionMatch : SearchMatch
    {
        ...
        internal ReflectionMatch(object source, Object value, object variable)
            : base(source, value)
        {
            Variable = variable;
        }
    ...
    public class AssetImporterDefaultValueMatch : SearchMatch
    {
        ...
        internal AssetImporterDefaultValueMatch(
            Object source,
            Object value,
            string variable,
            VariableGetterHolder[] monoScriptAllVariables
        )
            : base(source, value)
        {
            Variable = variable;
        ...
        protected override bool ChangeValue(Object newValue, out bool setContextDirty)
        {
            ...
            if (Source is MonoImporter)
            {
                ...
                {
                    if (
                        MonoScriptAllVariables[i].isSerializable
                        && !MonoScriptAllVariables[i].IsProperty
                    )
                    {
                        Object variableDefaultValue = monoImporter.GetDefaultReference(
                            MonoScriptAllVariables[i].Name
                        );
                        if (
                            variableDefaultValue == Value
                            && MonoScriptAllVariables[i].Name == Variable
                        )
                ...
                EditorApplication.delayCall += () =>
                    AssetDatabase.ImportAsset(monoImporter.assetPath); // If code recompiles during search, it will break the search. Give it a 1 frame delay
            }
            else if (Source is ShaderImporter)
            {
                ...
                for (int i = 0; i < shaderPropertyCount; i++)
                {
                    ...
                    {
                        Texture propertyDefaultValue = shaderImporter.GetNonModifiableTexture(
                            propertyName
                        );
                    ...
                    {
                        Texture propertyDefaultValue = shaderImporter.GetDefaultTexture(
                            propertyName
                        );
                        if (propertyDefaultValue == Value && propertyName == Variable)
                            propertyDefaultValue = (Texture)newValue;
                ...
                shaderImporter.SetNonModifiableTextures(
                    nonModifiableTextureNames.ToArray(),
                    nonModifiableTextureValues.ToArray()
                );
    ...
    {
        internal AnimationSystemMatch(object source, Object value, SetterFunction setter)
            : base(source, value, setter) { }

        internal AnimationSystemMatch(
            object source,
            Object value,
            Object context,
            SetterFunction setter
        )
            : base(source, value, context, setter) { }
    }
    ...
    public class BehaviourUsageMatch : ReadOnlySearchMatch
    {
        ...
        internal BehaviourUsageMatch(Object source, MonoScript value, Object behaviour)
            : base(source, value)
        {
            Behaviour = behaviour;
        }
    ...
    {
        internal PrefabMatch(Object source, Object value)
            : base(source, value) { }
    }
    ...
    {
        internal OtherSearchMatch(object source, Object value, SetterFunction setter)
            : base(source, value, setter) { }

        internal OtherSearchMatch(
            object source,
            Object value,
            Object context,
            SetterFunction setter
